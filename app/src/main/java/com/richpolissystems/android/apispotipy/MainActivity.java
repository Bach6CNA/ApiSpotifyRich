...
public class MainActivity extends AppCompatActivity implements ArtistListAdapter.CustomOnItemClickListener {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    adaptador = new ArtistListAdapter(MainActivity.this , artistas);
